export class BlockEditor {
    constructor(parentContainer) {
        ...
        this.previewCard = this.slashMenu.querySelector(".slash_preview_card");
        this.searchInput = this.slashMenu.querySelector(".slash_search_input");
        this.menuList = this.slashMenu.querySelector(".slash_menu_list");
    ...
    getHTML() {
        ...
        const originalCheckboxes = this.editable.querySelectorAll('input[type="checkbox"]');
    ...
    initEvents() {
        this.editable.addEventListener("input", (e) => {
            this.handleInput(e);
        ...
        this.bubbleToolbar.querySelectorAll("[data-command]").forEach((btn) => {
        ...
        this.bubbleToolbar.querySelectorAll("[data-color]").forEach((swatch) => {
        ...
        this.bubbleToolbar.querySelectorAll("[data-bg]").forEach((swatch) => {
            swatch.addEventListener("mousedown", (e) => {
                e.preventDefault();
        ...
        document.addEventListener("click", (e) => {
            if (this.isMenuOpen && !this.slashMenu.contains(e.target)) {
                this.closeSlashMenu();
            }
        });
        this.editable.addEventListener("change", (e) => {
    ...
    updatePreviewCard() {
        ...
        if (!activeCmd)
            return;
        const sampleEl = this.previewCard.querySelector(".slash_preview_sample");
        const titleEl = this.previewCard.querySelector(".slash_preview_title");
        const descEl = this.previewCard.querySelector(".slash_preview_desc");
        if (sampleEl)
            sampleEl.innerHTML = activeCmd.previewSample;
        if (titleEl)
            titleEl.textContent = activeCmd.previewTitle;
        if (descEl)
            descEl.textContent = activeCmd.previewDesc;
    }
    ...
    openMediaPrompt(type) {
        const title = this.mediaModal.querySelector("#media-modal-title");
        const urlLabel = this.mediaModal.querySelector("#media-url-label");
        const urlInput = this.mediaModal.querySelector("#media-url-input");
        const fileGroup = this.mediaModal.querySelector("#media-file-group");
        const captionGroup = this.mediaModal.querySelector("#media-caption-group");
        const captionInput = this.mediaModal.querySelector("#media-caption-input");
        const fileInput = this.mediaModal.querySelector("#media-file-input");
        const confirmBtn = this.mediaModal.querySelector("#media-confirm-btn");
        const cancelBtn = this.mediaModal.querySelector("#media-cancel-btn");
        const closeBtn = this.mediaModal.querySelector(".block_media_modal_close");
        urlInput.value = "";
        captionInput.value = "";
        fileInput.value = "";
        if (type === "image") {
    ...
    attachTaskCheckboxListeners() {
        this.editable.querySelectorAll(".block_task_list input[type='checkbox']").forEach((cb) => {
